...
export const StartTrackingButton = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
...
export const StopTrackingButton = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <StyledTrackingButton {...props}>
      <svg
        width="1em"
...
export const PauseTrackingButton = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <StyledTrackingButton {...props}>
      <svg
        width="1em"
...
export const EditTrackingButton = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <StyledTrackingButton {...props}>
      <svg
        width="1em"
...
export const FilterTaskButton = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <StyledTrackingButton {...props}>
      <svg
        width="1em"
